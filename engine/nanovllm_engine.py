...
from config import ENFORCE_EAGER, GPU_MEMORY_UTILIZATION, MAX_MODEL_LEN, MODEL_PATH
...
class NanoVLLMProfilerEngine:
    ...
    def warmup(self, max_output_tokens: int = 8) -> None:
        ...
        SYSTEM_PREFIX와 무관한 더미 프롬프트를 써서, 워밍업이 실제 워크로드의
